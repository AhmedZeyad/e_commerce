...
class OnbordingWidget extends StatelessWidget {
  ...
  OnbordingWidget({required this.onbordingModel,this.onTapLeftIcon,this.onTapRightText});
  @override
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Expanded(
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ListTile(
                    trailing: TextButton(onPressed: onTapRightText,
                      child: Text(
                    ...
                    leading: onbordingModel.leftIcon != null
                        ? GestureDetector(onTap: onTapLeftIcon,child: Image.asset(onbordingModel.leftIcon!))
                        : null,
                  ),
        ...
        // left title ,description and right  and left buttons
        Expanded(
          flex: 1,
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(color: Color(0xffA2A2A6), fontSize: 18),
                  textAlign: TextAlign.center,
                ),
              ],
            ),
